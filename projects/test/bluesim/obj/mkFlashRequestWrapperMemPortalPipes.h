...
/* Generation options: */
#ifndef __mkFlashRequestWrapperMemPortalPipes_h__
#define __mkFlashRequestWrapperMemPortalPipes_h__
...
/* Class declaration for the mkFlashRequestWrapperMemPortalPipes module */
class MOD_mkFlashRequestWrapperMemPortalPipes : public Module {
 ...
 public:
  ...
  MOD_Fifo<tUInt32> INST_memPortal_requestMemSlaves_5_fifoReadAddrGenerator_addrBeatFifo;
  MOD_Reg<tUInt8> INST_memPortal_requestMemSlaves_5_fifoReadAddrGenerator_addrReg;
  MOD_Reg<tUInt8> INST_memPortal_requestMemSlaves_5_fifoReadAddrGenerator_burstCountReg;
  MOD_Reg<tUInt8> INST_memPortal_requestMemSlaves_5_fifoReadAddrGenerator_isFirstReg;
  MOD_Reg<tUInt8> INST_memPortal_requestMemSlaves_5_fifoReadAddrGenerator_isLastReg;
  MOD_Fifo<tUInt32> INST_memPortal_requestMemSlaves_5_fifoReadAddrGenerator_requestFifo;
  MOD_Fifo<tUInt32> INST_memPortal_requestMemSlaves_5_fifoWriteAddrGenerator_addrBeatFifo;
  MOD_Reg<tUInt8> INST_memPortal_requestMemSlaves_5_fifoWriteAddrGenerator_addrReg;
  MOD_Reg<tUInt8> INST_memPortal_requestMemSlaves_5_fifoWriteAddrGenerator_burstCountReg;
  MOD_Reg<tUInt8> INST_memPortal_requestMemSlaves_5_fifoWriteAddrGenerator_isFirstReg;
  MOD_Reg<tUInt8> INST_memPortal_requestMemSlaves_5_fifoWriteAddrGenerator_isLastReg;
  MOD_Fifo<tUInt32> INST_memPortal_requestMemSlaves_5_fifoWriteAddrGenerator_requestFifo;
  MOD_Fifo<tUInt8> INST_memPortal_requestMemSlaves_5_fifoWriteDoneFifo;
  MOD_Fifo<tUInt8> INST_memPortal_requestMemSlaves_5_putFailedFifo;
  MOD_mkFlashRequestWrapperPipes INST_p;
 
 /* Constructor */
 public:
  MOD_mkFlashRequestWrapperMemPortalPipes(tSimStateHdl simHdl,
					  char const *name,
					  Module *parent,
					  tUInt32 ARG_id);
 ...
 public:
  ...
  tUWide PORT_pipes_readPage_PipeOut_first;
  tUWide PORT_pipes_writePage_PipeOut_first;
 
 /* Publicly accessible definitions */
 public:
  tUInt8 DEF_memPortal_memslave_ws_i_notEmpty____d385;
  tUInt8 DEF_memPortal_memslave_rs_i_notEmpty____d431;
  tUInt8 DEF_p_RDY_inputPipes_5_enq____d465;
  tUInt8 DEF_p_RDY_inputPipes_4_enq____d463;
  tUInt8 DEF_p_RDY_inputPipes_3_enq____d461;
  tUInt8 DEF_p_RDY_inputPipes_2_enq____d459;
  tUInt8 DEF_p_RDY_inputPipes_1_enq____d457;
  tUInt8 DEF_p_RDY_inputPipes_0_enq____d455;
  tUInt8 DEF_x__h17849;
  tUInt8 DEF_x__h19085;
  tUInt32 DEF_memPortal_requestMemSlaves_5_fifoWriteAddrGene_ETC___d595;
  tUInt32 DEF_memPortal_ctrlPort_ctrlWriteAddrGenerator_addr_ETC___d373;
  tUInt32 DEF_memPortal_indicationMemSlaves_0_fifoWriteAddrG_ETC___d600;
  tUInt32 DEF_memPortal_indicationMemSlaves_0_fifoReadAddrGe_ETC___d311;
  tUInt32 DEF_memPortal_requestMemSlaves_4_fifoWriteAddrGene_ETC___d590;
  tUInt32 DEF_memPortal_requestMemSlaves_3_fifoWriteAddrGene_ETC___d585;
  tUInt32 DEF_memPortal_requestMemSlaves_2_fifoWriteAddrGene_ETC___d580;
  tUInt32 DEF_memPortal_requestMemSlaves_1_fifoWriteAddrGene_ETC___d575;
  tUInt32 DEF_memPortal_requestMemSlaves_0_fifoWriteAddrGene_ETC___d569;
  tUInt8 DEF_x__h18792;
  tUInt8 DEF_x__h18527;
  tUInt8 DEF_x__h18580;
  tUInt8 DEF_x__h18633;
  tUInt8 DEF_x__h18686;
  tUInt8 DEF_x__h18739;
  tUInt8 DEF_memPortal_indicationMemSlaves_0_fifoReadAddrGe_ETC___d312;
  tUInt8 DEF_memPortal_indicationMemSlaves_0_fifoWriteAddrG_ETC___d601;
  tUInt8 DEF_memPortal_requestMemSlaves_5_fifoWriteAddrGene_ETC___d596;
  tUInt8 DEF_memPortal_requestMemSlaves_4_fifoWriteAddrGene_ETC___d591;
  tUInt8 DEF_memPortal_requestMemSlaves_3_fifoWriteAddrGene_ETC___d586;
  tUInt8 DEF_memPortal_requestMemSlaves_2_fifoWriteAddrGene_ETC___d581;
  tUInt8 DEF_memPortal_requestMemSlaves_1_fifoWriteAddrGene_ETC___d576;
  tUInt8 DEF_memPortal_requestMemSlaves_0_fifoWriteAddrGene_ETC___d570;
  tUInt8 DEF_memPortal_ctrlPort_ctrlWriteAddrGenerator_addr_ETC___d374;
  tUInt8 DEF_memPortal_indicationMemSlaves_0_fifoReadAddrGe_ETC___d313;
 
 /* Local definitions */
 private:
  tUInt8 DEF_memPortal_ctrlPort_interruptEnableReg__h18484;
  tUInt8 DEF_memPortal_putFailedIndicationFifo_notEmpty____d321;
  tUInt8 DEF_memPortal_memslave_rs_first__32_EQ_7___d452;
  tUInt8 DEF_memPortal_memslave_rs_first__32_EQ_6___d451;
  tUInt8 DEF_memPortal_memslave_rs_first__32_EQ_5___d450;
  tUInt8 DEF_memPortal_memslave_rs_first__32_EQ_4___d449;
  tUInt8 DEF_memPortal_memslave_rs_first__32_EQ_3___d448;
  tUInt8 DEF_memPortal_memslave_rs_first__32_EQ_2___d447;
  tUInt8 DEF_memPortal_memslave_rs_first__32_EQ_1___d446;
  tUInt8 DEF_memPortal_memslave_rs_first__32_EQ_0___d444;
  tUInt8 DEF_memPortal_memslave_ws_first__87_EQ_7___d406;
  tUInt8 DEF_memPortal_memslave_ws_first__87_EQ_6___d405;
  tUInt8 DEF_memPortal_memslave_ws_first__87_EQ_5___d404;
  tUInt8 DEF_memPortal_memslave_ws_first__87_EQ_4___d403;
  tUInt8 DEF_memPortal_memslave_ws_first__87_EQ_3___d402;
  tUInt8 DEF_memPortal_memslave_ws_first__87_EQ_2___d401;
  tUInt8 DEF_memPortal_memslave_ws_first__87_EQ_1___d400;
  tUInt8 DEF_memPortal_memslave_ws_first__87_EQ_0___d399;
 ...
 public:
  ...
  void RL_memPortal_requestMemSlaves_5_fifoReadAddrGenerator_addrBeatRule();
  void RL_memPortal_requestMemSlaves_5_fifoWriteAddrGenerator_addrBeatRule();
 ...
 public:
  ...
  void METH_pipes_inputPipes_5_enq(tUInt32 ARG_pipes_inputPipes_5_enq_v);
  tUInt8 METH_RDY_pipes_inputPipes_5_enq();
  tUInt8 METH_pipes_inputPipes_5_notFull();
  tUInt8 METH_RDY_pipes_inputPipes_5_notFull();
  ...
  tUWide METH_pipes_readPage_PipeOut_first();
  tUInt8 METH_RDY_pipes_readPage_PipeOut_first();
  void METH_pipes_readPage_PipeOut_deq();
  tUInt8 METH_RDY_pipes_readPage_PipeOut_deq();
  tUInt8 METH_pipes_readPage_PipeOut_notEmpty();
  tUInt8 METH_RDY_pipes_readPage_PipeOut_notEmpty();
  tUWide METH_pipes_writePage_PipeOut_first();
  tUInt8 METH_RDY_pipes_writePage_PipeOut_first();
  void METH_pipes_writePage_PipeOut_deq();
  tUInt8 METH_RDY_pipes_writePage_PipeOut_deq();
  tUInt8 METH_pipes_writePage_PipeOut_notEmpty();
  tUInt8 METH_RDY_pipes_writePage_PipeOut_notEmpty();
  tUInt32 METH_pipes_sendTest_PipeOut_first();
  tUInt8 METH_RDY_pipes_sendTest_PipeOut_first();
  void METH_pipes_sendTest_PipeOut_deq();
  tUInt8 METH_RDY_pipes_sendTest_PipeOut_deq();
  tUInt8 METH_pipes_sendTest_PipeOut_notEmpty();
  tUInt8 METH_RDY_pipes_sendTest_PipeOut_notEmpty();
  tUInt64 METH_pipes_addWriteHostBuffer_PipeOut_first();
  tUInt8 METH_RDY_pipes_addWriteHostBuffer_PipeOut_first();
  void METH_pipes_addWriteHostBuffer_PipeOut_deq();
  tUInt8 METH_RDY_pipes_addWriteHostBuffer_PipeOut_deq();
  tUInt8 METH_pipes_addWriteHostBuffer_PipeOut_notEmpty();
  tUInt8 METH_RDY_pipes_addWriteHostBuffer_PipeOut_notEmpty();
  tUInt64 METH_pipes_addReadHostBuffer_PipeOut_first();
  tUInt8 METH_RDY_pipes_addReadHostBuffer_PipeOut_first();
  void METH_pipes_addReadHostBuffer_PipeOut_deq();
  tUInt8 METH_RDY_pipes_addReadHostBuffer_PipeOut_deq();
  tUInt8 METH_pipes_addReadHostBuffer_PipeOut_notEmpty();
  tUInt8 METH_RDY_pipes_addReadHostBuffer_PipeOut_notEmpty();
 ...
 public:
  ...
  void vcd_defs(tVCDDumpType dt, MOD_mkFlashRequestWrapperMemPortalPipes &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkFlashRequestWrapperMemPortalPipes &backing);
  void vcd_submodules(tVCDDumpType dt,
		      unsigned int levels,
		      MOD_mkFlashRequestWrapperMemPortalPipes &backing);
};

#endif /* ifndef __mkFlashRequestWrapperMemPortalPipes_h__ */
