...
class MOD_mkDmaIndicationProxySynth : public Module {
 ...
 /* Module state */
 public:
  MOD_mkDmaIndicationProxyPortalSynth INST_dut_rv;
  ...
  MOD_Fifo<tUInt32> INST_memPortal_indicationMemSlaves_4_fifoReadAddrGenerator_addrBeatFifo;
  MOD_Reg<tUInt8> INST_memPortal_indicationMemSlaves_4_fifoReadAddrGenerator_addrReg;
  MOD_Reg<tUInt8> INST_memPortal_indicationMemSlaves_4_fifoReadAddrGenerator_burstCountReg;
  MOD_Reg<tUInt8> INST_memPortal_indicationMemSlaves_4_fifoReadAddrGenerator_isFirstReg;
  MOD_Reg<tUInt8> INST_memPortal_indicationMemSlaves_4_fifoReadAddrGenerator_isLastReg;
  MOD_Fifo<tUInt32> INST_memPortal_indicationMemSlaves_4_fifoReadAddrGenerator_requestFifo;
  MOD_Fifo<tUInt64> INST_memPortal_indicationMemSlaves_4_fifoReadDataFifo;
  MOD_Fifo<tUInt32> INST_memPortal_indicationMemSlaves_4_fifoWriteAddrGenerator_addrBeatFifo;
  MOD_Reg<tUInt8> INST_memPortal_indicationMemSlaves_4_fifoWriteAddrGenerator_addrReg;
  MOD_Reg<tUInt8> INST_memPortal_indicationMemSlaves_4_fifoWriteAddrGenerator_burstCountReg;
  MOD_Reg<tUInt8> INST_memPortal_indicationMemSlaves_4_fifoWriteAddrGenerator_isFirstReg;
  MOD_Reg<tUInt8> INST_memPortal_indicationMemSlaves_4_fifoWriteAddrGenerator_isLastReg;
  MOD_Fifo<tUInt32> INST_memPortal_indicationMemSlaves_4_fifoWriteAddrGenerator_requestFifo;
  MOD_Fifo<tUInt8> INST_memPortal_indicationMemSlaves_4_fifoWriteDoneFifo;
 ...
 public:
  tUInt8 DEF_memPortal_memslave_ws_i_notEmpty____d379;
  tUInt8 DEF_memPortal_memslave_rs_i_notEmpty____d417;
  tUInt8 DEF_x__h13957;
  tUInt8 DEF_x__h14963;
  tUInt32 DEF_memPortal_indicationMemSlaves_4_fifoWriteAddrG_ETC___d543;
  tUInt32 DEF_memPortal_indicationMemSlaves_4_fifoReadAddrGe_ETC___d303;
  tUInt32 DEF_memPortal_indicationMemSlaves_3_fifoWriteAddrG_ETC___d539;
  tUInt32 DEF_memPortal_indicationMemSlaves_3_fifoReadAddrGe_ETC___d239;
  tUInt32 DEF_memPortal_indicationMemSlaves_2_fifoWriteAddrG_ETC___d535;
  tUInt32 DEF_memPortal_indicationMemSlaves_2_fifoReadAddrGe_ETC___d175;
  tUInt32 DEF_memPortal_indicationMemSlaves_1_fifoWriteAddrG_ETC___d531;
  tUInt32 DEF_memPortal_indicationMemSlaves_1_fifoReadAddrGe_ETC___d111;
  tUInt32 DEF_memPortal_ctrlPort_ctrlWriteAddrGenerator_addr_ETC___d367;
  tUInt32 DEF_memPortal_indicationMemSlaves_0_fifoWriteAddrG_ETC___d527;
  tUInt32 DEF_memPortal_indicationMemSlaves_0_fifoReadAddrGe_ETC___d47;
  tUInt8 DEF_memPortal_indicationMemSlaves_4_fifoReadAddrGe_ETC___d304;
  ...
  tUInt8 DEF_memPortal_indicationMemSlaves_4_fifoWriteAddrG_ETC___d544;
  tUInt8 DEF_memPortal_indicationMemSlaves_3_fifoWriteAddrG_ETC___d540;
  tUInt8 DEF_memPortal_indicationMemSlaves_2_fifoWriteAddrG_ETC___d536;
  tUInt8 DEF_memPortal_indicationMemSlaves_1_fifoWriteAddrG_ETC___d532;
  tUInt8 DEF_memPortal_indicationMemSlaves_0_fifoWriteAddrG_ETC___d528;
  tUInt8 DEF_memPortal_ctrlPort_ctrlWriteAddrGenerator_addr_ETC___d368;
  tUInt8 DEF_memPortal_indicationMemSlaves_4_fifoReadAddrGe_ETC___d305;
 ...
 /* Local definitions */
 private:
  tUInt8 DEF_dut_rv_portalIfc_indications_4_notEmpty__15_OR_ETC___d458;
  ...
  tUInt8 DEF_dut_rv_portalIfc_indications_4_notEmpty____d315;
  tUInt8 DEF_memPortal_ctrlPort_interruptEnableReg__h14680;
  tUInt8 DEF_memPortal_memslave_rs_first__18_EQ_5___d442;
  tUInt8 DEF_memPortal_memslave_rs_first__18_EQ_4___d439;
  tUInt8 DEF_memPortal_memslave_rs_first__18_EQ_3___d436;
  tUInt8 DEF_memPortal_memslave_rs_first__18_EQ_2___d433;
  tUInt8 DEF_memPortal_memslave_rs_first__18_EQ_1___d430;
  tUInt8 DEF_memPortal_memslave_rs_first__18_EQ_0___d428;
  tUInt8 DEF_memPortal_memslave_ws_first__81_EQ_5___d396;
  tUInt8 DEF_memPortal_memslave_ws_first__81_EQ_4___d395;
  tUInt8 DEF_memPortal_memslave_ws_first__81_EQ_3___d394;
  tUInt8 DEF_memPortal_memslave_ws_first__81_EQ_2___d393;
  tUInt8 DEF_memPortal_memslave_ws_first__81_EQ_1___d392;
  tUInt8 DEF_memPortal_memslave_ws_first__81_EQ_0___d391;
 ...
 public:
  ...
  void RL_memPortal_indicationMemSlaves_4_fifoReadAddrGenerator_addrBeatRule();
  void RL_memPortal_indicationMemSlaves_4_fifoWriteAddrGenerator_addrBeatRule();
  void RL_memPortal_indicationMemSlaves_4_readDataRule();
 ...
 public:
  ...
  void vcd_submodules(tVCDDumpType dt, unsigned int levels, MOD_mkDmaIndicationProxySynth &backing);
};
