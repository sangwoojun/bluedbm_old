...
//
// On Fri Sep  5 01:50:19 EDT 2014
//
//
// Ports:
// Name                         I/O  size props
...
module mkAuroraIntra(CLK_gtp_clk,
  ...
  wire [127 : 0] x1__h1619, x1__h1752;
  wire [119 : 0] pdata__h2005;
  wire [31 : 0] x__h1246;
  wire [4 : 0] x__h790;
  ...
  SyncFIFO #(.dataWidth(32'd240),
	     .depth(32'd32),
	     .indxWidth(32'd5)) recvQ(.sCLK(auroraIntraImport_USER_CLK),
				      .dCLK(CLK),
  ...
  SyncFIFO #(.dataWidth(32'd240),
	     .depth(32'd32),
	     .indxWidth(32'd5)) sendQ(.sCLK(CLK),
  ...
  assign auroraGtResetCounter_D_IN =
	     auroraGtResetCounter_3_ULT_150000000___d24 ? x__h1246 : 32'd0 ;
  ...
  assign auroraIntraImport_TX_DATA =
	     packetSendBuffer[120] ? x1__h1619 : x1__h1752 ;
  assign auroraIntraImport_tx_en =
	     auroraIntraImport_tx_rdy && sendQ_dEMPTY_N ;

  // submodule recvQ
  assign recvQ_sD_IN = { auroraIntraImport_RX_DATA[119:0], pdata__h2005 } ;
  assign recvQ_sENQ =
  ...
  assign x1__h1752 = { 8'h0, sendQ_dD_OUT[119:0] } ;
  assign x__h1246 = auroraGtResetCounter + 32'd1 ;
  assign x__h790 = auroraIntraClockDiv2_count + 5'd1 ;
